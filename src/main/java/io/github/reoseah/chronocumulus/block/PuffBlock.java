...
public class PuffBlock extends Block {
    ...
    public static final AbstractBlock.Settings SETTINGS = AbstractBlock.Settings.create().noCollision().nonOpaque().breakInstantly().pistonBehavior(PistonBehavior.DESTROY).offset(OffsetType.XYZ).replaceable();
